 ...
 * Aciklama: Basit devre elemanlarýndan olusan bir devreyi dosyadan
...
void degisim(char setlenecekDeger[], int x,int kapiSayisi){
	...
	int i= 0,j,k,t,n,n1,b=0,c=0,d=0,min=0,m,m1,z,h,s,l,r,r1,kelimeSayisi = 0,say,say1=0,sayac1=0;
	int sayac2=0,b1,c1,nsn=0,dizi[20]={10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10};
